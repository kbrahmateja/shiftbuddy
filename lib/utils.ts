...
export const ROLE_CONFIG: Record<UserRole, RoleConfig> = {
  ...
  GAP_STAKEHOLDER: {
    label: "GAPINC",
    description: "GAPINC Client Stakeholder",
...
/**
 * Build a markdown export string for a handover note — used by GAPINC
...
${
  ...
  handover.incomingLeadNotes
    ? `## Incoming Lead Notes\n\n${handover.incomingLeadNotes}\n\n---\n\n`
    : ""
}*This document was auto-generated by ShiftBuddy — GAPINC/HCL Support Operations Platform.*
`;
}
